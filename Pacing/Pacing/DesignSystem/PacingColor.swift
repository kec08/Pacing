...
extension Color {
    ...
    // MARK: - Background
    static let backgroundPrimary = dynamic(light: "#FFFFFF", dark: "#151515")
    static let backgroundSecondary = dynamic(light: "#F5F5F7", dark: "#202020")

    // MARK: - Gray
    static let gray100 = dynamic(light: "#ECECEF", dark: "#292929")
    static let gray200 = dynamic(light: "#E3E3E6", dark: "#3A3A3A")
    static let gray300 = dynamic(light: "#D2D2D5", dark: "#4A4A4A")
    ...
    // MARK: - Divider
    static let dividerPrimary = dynamic(light: "#C8C8CC", dark: "#3A3A3C")
